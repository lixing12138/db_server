...
//            {
                ...
                if( move_uploaded_file($_FILES["file"]["tmp_name"], __DIR__."/../../services/upload/" . $name)){
                    echo upload_grade_file(__DIR__."/../../services/upload/" . $name);
                }
           // }
        }
    }elseif (isset($_POST['s_id']) && isset($_POST['course_id']) && isset($_POST['semester']) && isset($_POST['year']) && isset($_POST['grade'])){
        echo upload_grade($_POST['s_id'],$_POST['course_id'],$_POST['semester'],$_POST['year'],$_POST['grade']);
    }
}